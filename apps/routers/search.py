    ...
    async with request_semaphore:
        ...
        try:
            context = await elasticsearch_store.similarity_search(
                query=request.query, k=request.top_k, filter=request.filters
            )
...
async def keyword_search_request(request: SearchRequest):
    ...
    async with request_semaphore:
        ...
        try:
            context = await elasticsearch_store.keyword_search(
                query=request.query, k=request.top_k, filters=request.filters
            )
