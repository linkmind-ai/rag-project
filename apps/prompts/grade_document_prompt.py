...
_GRADE_PROMPT = ChatPromptTemplate.from_messages(
    [
        (
            ...
            문서에 질문과 관련된 키워드 또는 의미적으로 관련된 내용이 포함되어 있다면 해당 문서를 관련성이 있는 것으로 판단하세요.
            문서가 질문과 관련이 있는지 여부를 나타내기 위해 'yes' 또는 'no'의 이진 점수를 반환하세요.
            
            반드시 답변은 'yes' 또는 'no'로 하고 부연 설명은 하지 마세요.""",
        ),
        ("user", "검색된 문서: \n\n {document} \n\n 사용자 질문: {query}"),
    ]
)
